...
public class PhotoCarouselOptionsDialog extends GATrackerDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setItems(R.array.photo_carousel_menu, new DialogInterface.OnClickListener() {
            @Override
